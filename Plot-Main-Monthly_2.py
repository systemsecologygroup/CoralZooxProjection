...
for z in xrange(len(Locations)):
    for v in xrange(len(RCP)):
        ...
        if rcp == "RCP26":
            ...
            sub1.plot(time, 100*Trait2/PastTrait2, linewidth = 2, color = "black", label = "RCP 2.6 (without acclimation)")
            sub4.plot(time, 100*Host2/PastHost2, linewidth = 2, color = "black")
